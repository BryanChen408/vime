...
def _prepare_rollout_memory_handoff(args, actor_model, rollout_manager, tag) -> None:
    ...
    # The rollout weight shell is resident here, but KV has not returned yet.
...
def train(args):
    ...
    try:
        ...
        _prepare_rollout_memory_handoff(
            args,
            actor_model,
            rollout_manager,
            "startup",
        ...
        _finish_rollout_memory_handoff(
            args,
            actor_model,
            rollout_manager,
            "startup",
    ...
    for rollout_id in range(args.start_rollout_id, args.num_rollout):
        ...
        try:
            ...
            if args.offload_rollout:
                ...
                actor_model.probe_memory(
                    f"rollout {rollout_id} after rollout offload"
                )
