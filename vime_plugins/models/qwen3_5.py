...
class Qwen3_5GatedDeltaNet(nn.Module):
    ...
    def __init__(self, config, layer_idx: int, args=None, mcore_config=None, pg_collection=None):
        ...
        self._init_parallel(mcore_config, pg_collection)
        self._init_kernels(args)
        self._build_projections(config)
    ...
    def _init_parallel(self, mcore_config, pg_collection):
        """Resolve the TP and CP groups and derive the per-rank dimensions."""
        ...
        self._mcore_config = mcore_config
        ...
        self._mcore_config_no_sp = mcore_config
    ...
    def _build_projections(self, config):
        ...
        if self._tp_linear:
            self.in_proj = ColumnParallelLinear(
                ...
                init_method=self._mcore_config_no_sp.init_method,
                bias=False,
                gather_output=False,
                skip_bias_add=True,
