...
FEAT_PD_DISAGG=0 \
VLLM_SERVED_MODEL_NAME=/home/docker/Qwen3.6-35B-A3B-agentical-ascendc-hf-4t-bf16 \
...
TASK_QUEUE_ENABLE=1 \
ROLLOUT_BATCH_SIZE=16  N_SAMPLES_PER_PROMPT=8  GLOBAL_BATCH_SIZE=128  NUM_ROLLOUT=100 \
...
OPERATOR_DATA_ROOT=/home/docker/datasets/op_tasks/op_assets_drkernel_2k_difficulty_filtered_v3 \
OPERATOR_TASK_JSONL=/home/docker/datasets/op_tasks/op_assets_drkernel_2k_difficulty_filtered_v3/operator_tasks.ascendc.jsonl \
PROFILE_TRAIN=0 \
